...
// int min = minutesToSubtract, menosMin = 0, hour = 0;

//         min = minutesToSubtract;
//         if (minutesToSubtract % 60 == 0)
//         {
//             _minutes -= minutesToSubtract % 60;
//             Console.WriteLine("%%%%%%%%%%%%%%%%" + _minutes + "TRUE");
//         }

//         if (minutesToSubtract / 60 > 0)
//         {
//             hour = minutesToSubtract / 60;
//             _hours -= hour;
//             _minutes -= min;
//             Console.WriteLine("/////////////////// " + _hours + "Minutos " + _minutes + " min " + min + " MenosMin " + menosMin + " Hour " + hour);


//         }
//         else
//         if (minutesToSubtract % 60 > 0 && _minutes - minutesToSubtract < 0)
//         {
//             menosMin = (minutesToSubtract % 60) - _minutes;
//             _minutes = 60 - 7;
//             _hours -= 1;
//             Console.WriteLine("****************** " + _hours + "Minutos " + _minutes + " min " + min + " MenosMin " + menosMin + " Hour " + hour);
//         }